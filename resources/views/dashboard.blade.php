                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card bg-welcome-img overflow-hidden">
                                        <div class="card-body">
                                            <div class="">
                                                <h3 class=" fw-semibold fs-20 lh-base">
                                                    Upgrade you plan for <br/>Great experience
                                                </h3>
                                                <a href="#" class="btn btn-sm btn-danger">Upgarde Now</a>
                                                <img
                                                    src="{{asset('/public/projectFile/home')}}/assets/images/extra/fund.png"
                                                    alt=""
                                            ...
                                            <div>
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <form class="">
                                                        <select
                                                            ...
                                                            data-dynamic-select
                                                        >
                                                            <option value="1" data-img="{{asset('/public/projectFile/home')}}/assets/images/logos/m-card.png">
                                                                xx25
                                                            </option>
                                                            <option
                                                                value="2"
                                                ...
                                                <p class="mb-3 text-muted fw-semibold">
                                                    <span class="text-success"
                                                        ><i class="fas fa-arrow-up me-1"></i>11.1%</span
                                                    >
                                        ...
                                        <div class="card-body">
                                            <div class="row d-flex justify-content-center">
                                                ...
                                                <div class="col-3 align-self-center">
                                                    ...
                                                    >
                                                        <i
                                                            class="iconoir-cart fs-22 align-self-center mb-0 text-info"
                                                        ></i>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                        ...
                                        <div class="card-body">
                                            <div class="row d-flex justify-content-center">
                                                ...
                                                <div class="col-3 align-self-center">
                                                    ...
                                                    >
                                                        <i
                                                            class="iconoir-percentage-circle fs-22 align-self-center mb-0 text-warning"
                                                        ></i>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                        ...
                                        <div class="card-body">
                                            <div class="row d-flex justify-content-center">
                                                ...
                                                <div class="col-3 align-self-center">
                                                    ...
                                                    >
                                                        <i
                                                            class="iconoir-hexagon-dice fs-22 align-self-center mb-0 text-danger"
                                                        ></i>
                                                    </div>
                                                </div>
                                                <!--end col-->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="text-center mx-auto">
                                        <img
                                            src="{{asset('/public/projectFile/home')}}/assets/images/extra/rabit.png"
                                            alt=""
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <h6 class="my-0 fw-normal text-dark fs-13 mb-0">
                                                        You have $1.53 remaining found over ...<a
                                                            href="#"
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="">
                                                    <td class="px-0 pb-0">
                                                        <div class="d-flex align-items-center">
                                                            <img
                                                                src="{{asset('/public/projectFile/home')}}/assets/images/flags/baha_flag.jpg"
                                                                class="me-2 align-self-center thumb-sm rounded-circle"
                                                                alt="..."
                                                            />
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="bg-light py-3 px-2 mb-0 mt-3 text-center rounded">
                                        <h6 class="mb-0">
                                            <i class="icofont-calendar fs-5 me-1"></i> 01 January 2024 to 31 December
                                            2024
                                        </h6>
                                    </div>
                                </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img
                                                                src="{{asset('/public/projectFile/home')}}/assets/images/logos/lang-logo/chatgpt.png"
                                                                height="40"
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img
                                                                src="{{asset('/public/projectFile/home')}}/assets/images/logos/lang-logo/gitlab.png"
                                                                height="40"
                                                                class="me-3 align-self-center rounded"
                                                                alt="..."
                                                            />
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img
                                                                src="{{asset('/public/projectFile/home')}}/assets/images/logos/lang-logo/nextjs.png"
                                                                height="40"
                                                                class="me-3 align-self-center rounded"
                                                                alt="..."
                                                            />
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img
                                                                src="{{asset('/public/projectFile/home')}}/assets/images/logos/lang-logo/vue.png"
                                                                height="40"
                                                                class="me-3 align-self-center rounded"
                                                                alt="..."
                                                            />
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img
                                                                src="{{asset('/public/projectFile/home')}}/assets/images/logos/lang-logo/symfony.png"
                                                                height="40"
                                                                class="me-3 align-self-center rounded"
                                                                alt="..."
                                                            />
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="">
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img
                                                                src="{{asset('/public/projectFile/home')}}/assets/images/users/avatar-2.jpg"
                                                                height="36"
                                                                class="me-2 align-self-center rounded"
                                                                alt="..."
                                                            />
                                                ...
                                                <tr class="">
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img
                                                                src="{{asset('/public/projectFile/home')}}/assets/images/users/avatar-3.jpg"
                                                                height="36"
                                                                class="me-2 align-self-center rounded"
                                                                alt="..."
                                                            />
                                                ...
                                                <tr class="">
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img
                                                                src="{{asset('/public/projectFile/home')}}/assets/images/users/avatar-4.jpg"
                                                                height="36"
                                                                class="me-2 align-self-center rounded"
                                                                alt="..."
                                                            />
                                                ...
                                                <tr>
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img
                                                                src="{{asset('/public/projectFile/home')}}/assets/images/users/avatar-5.jpg"
                                                                height="36"
                                                                class="me-2 align-self-center rounded"
                                                                alt="..."
                                                            />
                                                ...
                                                <tr class="">
                                                    <td class="px-0">
                                                        <div class="d-flex align-items-center">
                                                            <img
                                                                src="{{asset('/public/projectFile/home')}}/assets/images/users/avatar-9.jpg"
                                                                height="36"
                                                                class="me-2 align-self-center rounded"
                                                                alt="..."
                                                            />
